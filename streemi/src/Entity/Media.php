...
class Media
{
    ...
    public function addSerie(season $serie): static
    {
    ...
    public function removeSerie(season $serie): static
    {
    ...
    public function addMedium(language $medium): static
    {
    ...
    public function removeMedium(language $medium): static
    {
